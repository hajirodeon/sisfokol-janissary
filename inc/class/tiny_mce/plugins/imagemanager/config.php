...
//	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../filebox/materi'; // absolute or relative from this script path, required.
	...
	$url_perso = dirname(__FILE__).'/../../../../../../../filebox/materi';
//	$url_perso1 = dirname(__FILE__).'/../../../../../../filebox/materi';
//	$url_perso1 = dirname(__FILE__).'/filebox/materi';
//	$url_perso1 = '../../../../../filebox/materi';
	$url_perso = realpath($url_perso1);
//	$url_perso = $url_perso1;
	$mcImageManagerConfig['filesystem.path'] = $url_perso; 
	$mcImageManagerConfig['filesystem.rootpath'] = $url_perso;
